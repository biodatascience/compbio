...
|:-----|:------|:-----|:---|:-----|:------|
| | **Data analysis** | | | | |
| Aug 19 & 21 | Biological intro / GitHub | `-` | [HW0](`r hw("github/github_HW")`) | [github](github.html) | RStudio, git, and GitHub |
| Aug 26 & 28 | Exploring bio data | `eda` | | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| Sep 4 | R/Bioconductor I | `bioc` | | [objects](bioc/objects.html) | Bioc data objects |
| | | | | [ranges](bioc/ranges.html) | Genomic ranges |
| | | | |  [GRL](bioc/GRL.html) | GRangesList: lists of ranges |
| Sep 9 & 11 | "tidyomics" | `tidy` | | [tidy intro](https://tidyomics.github.io/tidy-intro-talk/) | Tidiness-in-Bioconductor intro |
| | | | | [tidy ranges](https://tidyomics.github.io/tidy-ranges-tutorial/) | Tidy ranges tutorial |
| | R/Bioconductor II | `bioc` | | [anno](bioc/anno.html) | Accessing annotations |
| | | | | [strings](bioc/strings.html) | Manipulating DNA strings |
| Sep 16 & 18 | Distances & norm. I | `dist` | | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
| Sep 23 | Wellness day | | | | |
| Sep 25 | Spatial data analysis (guest lecture) | | | | |
| Sep 30 | BCB retreat | | | | |
| Oct 2 | Distances & norm. II | `dist` | | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| | | | | | Batch effect solutions |
| | **Data modeling** | | | | |
| Oct 7 & 9 | Models and EM | `model` | | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| | ChIP-seq | | | | |
| | Motifs part II | | | | (EM notes posted to GH) |
...
| Oct 21 & 23 | Markov models | `markov` | | [hmm](markov/hmm.html) | Hidden Markov Models |
| Oct 28 & 30 | Simultaneous Hypothesis Testing | `multiple` | | [multtest](multiple/multtest.html) | FDR and Benjamini-Hochberg |
| | | | | [localfdr](multiple/localfdr.html) | Local false discovery rate |
| | | | | [IDR](multiple/IDR.html) | Irreproducible discovery rate |
| Nov 4 | TBA | | | | |
| Nov 6 | Guest lecture TBA | | | | |
| Nov 11 & 23 | Network analysis | `net` | | [network](net/network.html) | Network analysis |
| Nov 18 & 20 | python for bio data | `python` | | | |
