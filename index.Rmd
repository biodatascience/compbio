...
|------|-------|------|----|------|-------|
| 1/19 | GitHub | | [HW0](https://github.com/biodatascience/compbio_src/blob/master/github/github_HW.Rmd) | [github](github.html) | RStudio, git, and GitHub |
...
| 2/2 | Bioconductor | `bioc` | <!--[♫](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc1_HW.Rmd)--> | [objects](bioc/objects.html) | Complex data objects: eSet |
| | | | | [ranges](bioc/ranges.html) | Genomic ranges |
| | | | |  [GRL](bioc/GRL.html) | GRangesList: lists of ranges |
| | Bioconductor | `bioc` | <!--[♬](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc2_HW.Rmd)--> | [SE](bioc/SE.html) | The SummarizedExperiment |
...
| | Distances & norm. | `dist` | <!--[⚠](https://github.com/biodatascience/compbio_src/blob/master/dist/dist2_HW.Rmd)--> | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| (2/16) | *Break* | | | | |
| 2/18 | Multiple testing | `test` | | [multtest](test/multtest.html) | FDR and Benjamini-Hochberg |
