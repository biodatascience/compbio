...
| (9/26) | *Well-being day* | | | | |
| 9/28 | Distances & norm. I | `dist` | [](`r hw("dist/dist1_HW")`) | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
| | Distances & norm. II | | [](`r hw("dist/dist2_HW")`) | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| 10/3 | Models and EM | `model` | [](`r hw("model/model_HW")`) | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| 10/5 | Motifs & {memes} | | | | Guest: [Spencer Nystrom](https://snystrom.github.io/) |
| 10/10 | Hierarchical models | `hier` |  [](`r hw("hier/hier_HW")`) | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| (10/12) | *University day* | | | | |
| 10/17 | Signal processing | `signal` | [](`r hw("signal/hier-signal_HW")`) | [hmm](signal/hmm.html) | Hidden Markov Models |
| 10/24 | Network analysis | `net` | | [network](net/network.html) | Network analysis |
| 10/31 | Tidy genomics | `-` | | [tidy](https://nullranges.github.io/tidy-ranges-tutorial/) | Tidy ranges tutorial |
| 11/7 | *Project time* | | | | |
| 11/16 | *Presentations 1* | | | | |
| 11/14 | *Presentations 2* | | | | |
