...
|:-----|:------|:-----|:---|:-----|:------|
| 8/15 | GitHub | `-` | [HW0](`r hw("github/github_HW")`) | [github](github.html) | RStudio, git, and GitHub |
| 8/22 | R & EDA | `eda` | [](`r hw("eda/EDA_HW.Rmd")`) | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [NAs](eda/NAs.html) | Missing values in R |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| 8/29 | Bioconductor | `bioc` | [](`r hw("bioc/bioc_HW.Rmd")`) | [objects](bioc/objects.html) | Complex data objects: eSet |
