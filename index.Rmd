...
|:-----|:------|:-----|:---|:-----|:------|
| | **Data analysis** | | | | |
| | Biological intro / GitHub | `-` | [HW0](`r hw("github/github_HW")`) | [github](github.html) | RStudio, git, and GitHub |
| | Exploring bio data | `eda` | | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| | R/Bioconductor I | `bioc` | | [objects](bioc/objects.html) | Bioc data objects |
| | | | | [ranges](bioc/ranges.html) | Genomic ranges |
| | | | |  [GRL](bioc/GRL.html) | GRangesList: lists of ranges |
| | "tidyomics" | `tidy` | | [tidy intro](https://tidyomics.github.io/tidy-intro-talk/) | Tidiness-in-Bioconductor intro |
| | | | | [tidy ranges](https://tidyomics.github.io/tidy-ranges-tutorial/) | Tidy ranges tutorial |
| | R/Bioconductor II | | | [anno](bioc/anno.html) | Accessing annotations |
...
| | Simultaneous Hypothesis Testing | `multiple` | | [multtest](multiple/multtest.html) | FDR and Benjamini-Hochberg |
