...
Spring 2021, 9:30-10:45 TR (exclusively remote, no in-person component)

For official course information see [Sakai](https://sakai.unc.edu/portal/site/bios784-2021) 
(syllabus, calendar, paper PDFs, etc).
...
**For 2021 BCB students**: BCB 720 (background on statistical inference,
i.e. working with the likelihood for parameter inference, conditional
probabilities) is suitable as a pre-requisite for BIOS 784.
...
|------|-------|------|----|------|-------|
| 1/19 | GitHub | | [💻](https://github.com/biodatascience/compbio_src/blob/master/github/github_HW.Rmd) | [github](github.html) | RStudio, git, and GitHub |
| 1/26 | R & EDA | `eda` | [🔭](https://github.com/biodatascience/compbio_src/blob/master/eda/EDA_HW.Rmd) | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [NAs](eda/NAs.html) | Missing values in R |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| 2/2 | Bioconductor | `bioc` | [♫](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc_HW.Rmd) | [objects](bioc/objects.html) | Complex data objects: eSet |
| | | | | [ranges](bioc/ranges.html) | Genomic ranges |
| | | | |  [GRL](bioc/GRL.html) | GRangesList: lists of ranges |
| | Bioconductor | `bioc` | | [SE](bioc/SE.html) | The SummarizedExperiment |
| | | | | [anno](bioc/anno.html) | Accessing annotations |
| | | | | [strings](bioc/strings.html) | Manipulating DNA strings |
| 2/9 | Distances & norm. | `dist` | [⚖](https://github.com/biodatascience/compbio_src/blob/master/dist/dist1_HW.Rmd) | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
| (2/16) | *Break* | | | | |
| 2/18 | Distances & norm. | `dist` | <!--[⚠](https://github.com/biodatascience/compbio_src/blob/master/dist/dist2_HW.Rmd)--> | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| 2/23 | *Guest lecture* | | | | Dr. Joshua Starmer |
| 2/25 | Multiple testing | `test` | | [multtest](test/multtest.html) | FDR and Benjamini-Hochberg |
| 3/2  | Multiple testing | `test` | | [localfdr](test/localfdr.html) | Local false discovery rate |
| | | | |  [IDR](test/IDR.html) | Irreproducible discovery rate |
| 3/4 | *Mid-term assigned* | | | | |
| 3/9 | *Guest lecture* | | | | Dr. Di Wu |
| (3/11) | *Break* | | | | |
| 3/16 | Models and EM | `model` | <!--[⛰](https://github.com/biodatascience/compbio_src/blob/master/model/model_HW.Rmd)--> | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| 3/23 | Hierarchical models | `hier` |  <!--[♔](https://github.com/biodatascience/compbio_src/blob/master/hier/hier_HW.Rmd)--> | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| 3/30 | Signal processing | `signal` | <!--[⛓](https://github.com/biodatascience/compbio_src/blob/master/signal/signal_HW.Rmd)--> | [hmm](signal/hmm.html) | Hidden Markov Models |
| 4/6 | Network analysis | `net` | | [network](net/network.html) | Network analysis |
| 4/13 | *Guest lecture* | | | | Dr. Yuchao Jiang |
| 4/15 | *TBD* | | | | |
| 4/20 | *Project time* | | | | |
| 4/27 | *Presentations 1* | | | | |
| 4/29 | *Presentations 2* | | | | |
| 5/4 | *Presentations 3* | | | | |
