...
| 10/24 | *Project groups* | | | | |
| 10/26 | | | | | |
| 10/31 | | | | | |
| 11/2 | | | | | |
| TBD | Hierarchical models | `hier` | | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| TBD | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| TBD | Signal processing | `signal` | | [hmm](signal/hmm.html) | Hidden Markov Models |
| TBD | Network analysis | `net` | | [network](net/network.html) | Network analysis |
| TBD | Tidy genomics | `-` | | [tidy](https://nullranges.github.io/tidy-ranges-tutorial/) | Tidy ranges tutorial |
| 11/7 | *Project time* | | | | |
