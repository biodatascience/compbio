...
| 8/22 | Simple EDA (<font color="red">virtual</font>) | `eda` | [](`r hw("eda/EDA_HW.Rmd")`) | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [NAs](eda/NAs.html) | Missing values in R |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| 8/29 | Bioconductor I | `bioc` | [](`r hw("bioc/bioc_HW.Rmd")`) | [objects](bioc/objects.html) | Complex data objects: eSet |
| | | | | [ranges](bioc/ranges.html) | Genomic ranges |
| | | | |  [GRL](bioc/GRL.html) | GRangesList: lists of ranges |
| | Bioconductor II | `bioc` | | [SE](bioc/SE.html) | The SummarizedExperiment |
| | | | | [anno](bioc/anno.html) | Accessing annotations |
| | | | | [strings](bioc/strings.html) | Manipulating DNA strings |
| (9/5) | *Labor day* | | | | |
| 9/7 | Distances & norm. I | `dist` | [](`r hw("dist/dist1_HW.Rmd")`) | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
| 9/12 | Multiple testing | `test` | | [multtest](test/multtest.html) | FDR and Benjamini-Hochberg |
...
| 9/19 | Multiple testing | `test` | | | |
| 9/21 | Mult. test. w/ codata | | | | Guest: [Nikos Ignatiadis](https://nignatiadis.github.io/) |
| (9/26) | *Well-being day* | | | | |
| 9/28 | Distances & norm. II | `dist` | [](`r hw("dist/dist2_HW.Rmd")`) | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| 10/3 | Models and EM | `model` | [](`r hw("model/model_HW.Rmd")`) | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| 10/5 | Motifs & {memes} | | | | Guest: [Spencer Nystrom](https://snystrom.github.io/) |
| 10/10 | Hierarchical models | `hier` |  [](`r hw("hier/hier_HW.Rmd")`) | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| (10/12) | *University day* | | | | |
| 10/17 | Signal processing | `signal` | [](`r hw("signal/hier-signal_HW.Rmd")`) | [hmm](signal/hmm.html) | Hidden Markov Models |
