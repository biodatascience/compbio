...
|Sep 18 & 20    | Distances & norm. | `dist` | | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
|Sep 25 & 27    | Distances & norm. | `dist` | | [batch](dist/batch.html) | Batch effects and sources |
...
|Oct 23 & 25    | Models and EM | `model` | | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
|Oct 30 & Nov 1 | Hierarchical models | `hier` | | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
|Nov 6 & 8	    | Signal processing | `signal` | | [hmm](signal/hmm.html) | Hidden Markov Models |
|Nov 13 & 15    | Network analysis | `net` | | | |
