...
You can also find a
[list of base R functions](https://github.com/mikelove/compbio/blob/gh-pages/eda/functions.md)
...
|LbrDay & Sep 6 | Bioconductor | `bioc` | objects, ranges, rangeslist, SummarizedExperiment, annotations, biostrings |
