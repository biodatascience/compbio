...
|------|-------|------|----|------|-------|
| | GitHub | | [HW0](https://github.com/biodatascience/compbio_src/blob/master/github/github_HW.Rmd) | [github](github.html) | RStudio, git, and GitHub |
| | R & EDA | `eda` | <!--[🔭](https://github.com/biodatascience/compbio_src/blob/master/eda/EDA_HW.Rmd)--> | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [NAs](eda/NAs.html) | Missing values in R |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| | Bioconductor | `bioc` | <!--[♫](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc1_HW.Rmd)--> | [objects](bioc/objects.html) | Complex data objects: eSet |
...
| | Distances & norm. | `dist` | <!--[⚖](https://github.com/biodatascience/compbio_src/blob/master/dist/dist1_HW.Rmd)--> | [distances](dist/distances.html) | Distances in high dimensions |
...
| | *Mid-term* | | | | |
| | *Break* | | | | |
| | Models and EM | `model` | <!--[⛰](https://github.com/biodatascience/compbio_src/blob/master/model/model_HW.Rmd)--> | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| | Hierarchical models | `hier` |  <!--[♔](https://github.com/biodatascience/compbio_src/blob/master/hier/hier_HW.Rmd)--> | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| | Signal processing | `signal` | <!--[⛓](https://github.com/biodatascience/compbio_src/blob/master/signal/signal_HW.Rmd)--> | [hmm](signal/hmm.html) | Hidden Markov Models |
