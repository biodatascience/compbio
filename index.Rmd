...
|LbrDay & Sep 6 | Bioconductor | `bioc` | [♫](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc1_HW.Rmd) | [objects](bioc/objects.html), [ranges](bioc/ranges.html), [GRangesList](bioc/GRL.html) |
|Sep 11 & 13    | Bioc. continued | `bioc` | [𝄞](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc2_HW.Rmd) | [SummarizedExperiment](bioc/SE.html), [anno](bioc/anno.html), [strings](bioc/strings.html) |
...
|Oct 2 & 4      | Multiple testing | `test` | | [multtest](test/multtest.html), [localfdr](test/localfdr.html), [IDR](test/IDR.html) |
|Oct 9 & 11	    | *Mid-term* | | | |
|Oct 16 & 18    | *Fall break* | | | |
|Oct 23 & 25    | Models and EM | `model` | | [EM](model/EM.html), [motif](model/motif.html) |
|Oct 30 & Nov 1 | Hierarchical models | `hier` | | [hierarchical](hier/hierarchical.html), [jamesstein](hier/jamesstein.html) |
|Nov 6 & 8	    | Signal processing | `signal` | | |
...
* **Network analysis**
    - [Static And Dynamic DNA Loops Form AP-1 Bound Activation Hubs During Macrophage Development](http://www.biorxiv.org/content/early/2017/05/25/142026) - Phanstiel et al
