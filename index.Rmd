...
|------|-------|------|----|------|-------|
| 8/15 | GitHub | | [](https://github.com/biodatascience/compbio_src/blob/master/github/github_HW.Rmd) | [github](github.html) | RStudio, git, and GitHub |
| 8/22 | R & EDA | `eda` | [](https://github.com/biodatascience/compbio_src/blob/master/eda/EDA_HW.Rmd) | [EDA](eda/EDA.html) | Exploratory data analysis |
| | | | | [NAs](eda/NAs.html) | Missing values in R |
| | | | | [brain RNA](eda/brain_RNA.html) | Exploring brain RNA |
| 8/29 | Bioconductor | `bioc` | [](https://github.com/biodatascience/compbio_src/blob/master/bioc/bioc_HW.Rmd) | [objects](bioc/objects.html) | Complex data objects: eSet |
...
| (9/5) | *Labor day* | | | | |
| 9/7 | Distances & norm. | `dist` | [](https://github.com/biodatascience/compbio_src/blob/master/dist/dist1_HW.Rmd) | [distances](dist/distances.html) | Distances in high dimensions |
| | | | | [hclust](dist/hclust.html) | Hierarchical clustering |
| 9/12 | Distances & norm. | `dist` | [](https://github.com/biodatascience/compbio_src/blob/master/dist/dist2_HW.Rmd) | [batch](dist/batch.html) | Batch effects and sources |
| | | | |  [sva](dist/sva.html) | Surrogate variable analysis |
| (9/26) | *Well-being day* | | | | |
| 9/28 | Multiple testing | `test` | | [multtest](test/multtest.html) | FDR and Benjamini-Hochberg |
| | | | | [localfdr](test/localfdr.html) | Local false discovery rate |
| | | | | [IDR](test/IDR.html) | Irreproducible discovery rate |
| 10/3 | Models and EM | `model` | [](https://github.com/biodatascience/compbio_src/blob/master/model/model_HW.Rmd) | [EM](model/EM.html) | Expectation maximization |
| | | | |  [motif](model/motif.html) | EM for finding DNA motifs |
| 10/10 | Hierarchical models | `hier` |  <!--[♔](https://github.com/biodatascience/compbio_src/blob/master/hier/hier_HW.Rmd)--> | [hierarchical](hier/hierarchical.html) | Hierarchical models |
| | | | |  [jamesstein](hier/jamesstein.html) | James-Stein estimator app |
| (10/12) | *University day* | | | | |
| 10/17 | Signal processing | `signal` | [](https://github.com/biodatascience/compbio_src/blob/master/signal/hier-signal_HW.Rmd) | [hmm](signal/hmm.html) | Hidden Markov Models |
