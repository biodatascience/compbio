...
distances across samples. We will discuss distances and normalization
techniques in a later section. One consequence of quantile
normalization is that the boxplots are identical afterward.
